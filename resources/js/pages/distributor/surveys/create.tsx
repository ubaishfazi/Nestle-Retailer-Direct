...
export default function DistributorSurveysCreate() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('/distributor/surveys', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                window.location.href = '/distributor/surveys';
            } else {
                    ...
                    <div className="px-4 py-4 md:px-6">
                        ...
                        <div className="mt-3">
                            <h1 className="text-lg font-bold tracking-tight text-slate-900 md:text-xl">
                                Create Demand Sensing Survey
                            </h1>
                            <p className="text-xs font-medium text-slate-500">
                                Design a questionnaire to understand retailer
